...
class PostApiTestCase(TestCase):
    ...
    def test_post_list(self):
        resp = self.client.get("/blog/api/v1/posts/")
        ...
        for post_dict in data:
            ...
            self.assertTrue(
                post_dict["author"].endswith(f"/blog/api/v1/users/{post_obj.author.email}/")
            )
            self.assertEqual(
    ...
    def test_unauthenticated_post_create(self):
        ...
        post_dict = {
            ...
            "author": "http://testserver/blog/api/v1/users/test@example.com/",
            "published_at": "2021-01-10T09:00:00Z",
        }
        resp = self.client.post("/blog/api/v1/posts/", post_dict)
